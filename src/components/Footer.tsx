      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-wrap justify-between">
          <div className="w-full md:w-1/3 mb-6 md:mb-0">
            <h3 className="text-xl font-bold mb-2">Epic Game Hub</h3>
            <p className="text-gray-400">Your gateway to gaming adventures</p>
          </div>
          <div className="w-full md:w-1/3 mb-6 md:mb-0">
        ...
        <div className="mt-8 text-center text-gray-400">
          <p>&copy; 2024 Eggy Car Game Hub. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
